...
return [
    ...
    'login' => 'Anmelden',
    'logout' => 'Abmelden',
    'logged-in-as' => 'Angemeldet als {displayName}',
    ...
    'registration-hint' => '
        ...
        erhältst dann einen Link per E-Mail, mit dem du dich in die Liste eintragen kannst. Alternativ kannst du dich
        auch mit deinem Google oder Telegram Account anmelden. 
    ',
...
{loginUrl}
    ...
    'covid-19-paragraph' => '
        Der Suitwalk findet unter strenger Beachtung unseres
        <a href="https://docs.google.com/document/d/16x7irytgXEWcA6n0hzKhaF8qvcWNmHT9Oc8QiEu2_1U/edit?usp=sharing">Hygienekonzeptes</a>
        statt. Bitte lest euch dieses aufmerksam durch. 
    ',
];
